...
public class JobCompanyAdapter extends RecyclerView.Adapter<JobCompanyAdapter.MyViewHolder> {
    ...
    Context context;
    private boolean tag;
    public JobCompanyAdapter(List<Job> jobList, Context context) {
    ...
    public void onBindViewHolder(@NonNull JobCompanyAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context,"Bạn đã chọn cong ty"+holder.nameJob.getText().toString(), Toast.LENGTH_SHORT).show();
