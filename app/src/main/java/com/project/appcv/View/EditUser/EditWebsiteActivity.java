...
public class EditWebsiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName=findViewById(R.id.editTextWebsite);
        btnComplete=findViewById(R.id.btnWComplete);
        btnCancel=findViewById(R.id.btnWCancel);
                        ...
                        call.enqueue(new Callback<ProfileUser>() {
                            ...
                            public void onResponse(Call<ProfileUser> call, Response<ProfileUser> response) {
                                if (response.isSuccessful()) {
                                    Intent intent = new Intent(EditWebsiteActivity.this, EditInforActivity.class);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EditWebsiteActivity.this, ProfileUserActivity.class);
                startActivity(intent);
                finish();
            }
        });
